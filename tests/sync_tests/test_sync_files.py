...
from invenio_nrp.client.sync_client.files import File, FilesClient, TransferType
from invenio_nrp.client.sync_client.records import Record
from invenio_nrp.client.sync_client.streams import MemorySink, MemorySource
...
def test_multipart_upload(draft_record_with_files: Record, data_size, parts):
    ...
    committed_upload: File = files.upload(
        key="blah.txt",
        metadata={"title": "blah"},
    ...
    sink = MemorySink()
    committed_upload.download(sink)
